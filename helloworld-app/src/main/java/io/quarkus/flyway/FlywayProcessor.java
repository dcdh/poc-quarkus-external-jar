...
/**
 * @deprecated remove when https://github.com/quarkusio/quarkus/pull/3793 is merged
 */
@Deprecated
        ...
        try {
            ...
            for (String location : locations) {
                ...
                while (migrations.hasMoreElements()) {
                    ...
                    LOGGER.infov("Adding application migrations in path ''{0}'' using protocol ''{1}''", path.getPath(), path.getProtocol());
                    ...
                    if (JAR_APPLICATION_MIGRATIONS_PROTOCOL.equals(path.getProtocol())) {
                        ...
                        LOGGER.warnv("Unsupported URL protocol ''{0}'' for path ''{1}''. Migration files will not be discovered.", path.getProtocol(), path.getPath());
